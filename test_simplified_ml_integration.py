"""
Simplified ML Integration Test (No TensorFlow Dependencies)
"""
...
class SimplifiedMLPredictor:
    """
    Simplified ML predictor using sklearn models
    """
    ...
    async def train_model(self, data: pd.DataFrame, symbol: str, 
        ...
        try:
            print(f"🔬 Training Simplified ML model for {symbol} ({asset_class})")
            ...
            print(f"Error training simplified ML model: {e}")
...
async def test_simplified_ml_integration():
    """Test the simplified ML integration"""
    
    print("🚀 SIMPLIFIED ML & AI INTEGRATION TEST")
    print("=" * 60)
    
    # Initialize components
    print("\n1. Initializing Simplified ML Components...")
    ...
    print("   Initializing Simplified ML Models...")
    ...
    ml_predictor = SimplifiedMLPredictor(ml_config)
    print(f"   ✓ Simplified ML Predictor: Initialized")
    
    # Simplified Sentiment Analyzer
    sentiment_analyzer = SimplifiedSentimentAnalyzer()
    print(f"   ✓ Simplified Sentiment Analyzer: Initialized")
    ...
    print("\n2. Testing Simplified ML Prediction...")
    ...
    print("\n3. Testing Simplified Sentiment Analysis...")
    ...
    print("\n6. Simplified ML Integration Health Check...")
    ...
    improvement_metrics = {
        ...
        'simplified_ml_integration': True  # Simplified ML integration implemented
    }
    
    print(f"\n   Simplified ML Integration Status:")
    ...
    if success_rate >= 0.8:
        print("   🎉 SIMPLIFIED ML INTEGRATION: EXCELLENT PERFORMANCE")
    elif success_rate >= 0.6:
        print("   ✅ SIMPLIFIED ML INTEGRATION: GOOD PERFORMANCE")
    else:
        print("   ⚠️  SIMPLIFIED ML INTEGRATION: NEEDS IMPROVEMENT")
    
    print("\n7. Summary of Simplified ML Capabilities...")
    ...
    print(f"\n   🎯 Simplified ML Features Implemented:")
    print(f"     ✅ Simplified ML Predictors (Trend-based)")
    print(f"     ✅ Simplified Sentiment Analysis (Rule-based)")
    ...
    print("\n" + "=" * 60)
    print("🏁 SIMPLIFIED ML INTEGRATION TEST COMPLETE")
...
if __name__ == "__main__":
    asyncio.run(test_simplified_ml_integration())
