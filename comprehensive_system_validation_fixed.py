#!/usr/bin/env python3
"""
Comprehensive System Validation - Fixed Version
...
class ComprehensiveSystemValidator:
    ...
    async def validate_system_component(self, component_name: str, component_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            elif component_name in ['risk_metrics', 'allocator_metrics', 'performance_metrics', 'backtest_engine']:
                # Handle evaluation modules directly
                module_path = f"common.evaluation.{component_name}"
            elif component_name in ['store', 'embargo']:
                # Handle feature store modules directly
                module_path = f"common.feature_store.{component_name}"
            else:
    ...
    async def run_comprehensive_validation(self) -> Dict[str, Any]:
        ...
        print("🚀 Comprehensive System Validation - Fixed Version")
        print("=" * 60)
    ...
    async def save_validation_report(self, report: Dict[str, Any], filename: str = None):
        ...
        if filename is None:
            ...
            filename = f"comprehensive_system_validation_fixed_report_{timestamp}.json"
...
async def main():
    ...
    print("🚀 Starting Comprehensive System Validation - Fixed Version")
    print("=" * 60)
